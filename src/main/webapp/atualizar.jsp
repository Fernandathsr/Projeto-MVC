				...
				<div class="form-group">
					...
					<div class="form-group">
						<label for="nome">Nome:</label> <input type="text"
							class="form-control" id="name" name="userName" value="${usuario.userName}" required>
					</div>
					<div class="form-group">
						<label for="login">Login:</label> <input type="text"
							class="form-control" id="login" name="userLogin" value="${usuario.userLogin}" required>
					</div>
					<div class="form-group">
						<label for="senha">Senha:</label> <input type="password"
							class="form-control" id="senha" name="userSenha" value="${usuario.userSenha}" required>
					</div>
